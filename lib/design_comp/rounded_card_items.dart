...
class RoundedCardWithItems extends StatefulWidget {
  @override
  _RoundedCardWithItemsState createState() => _RoundedCardWithItemsState();
}

class _RoundedCardWithItemsState extends State<RoundedCardWithItems> {
